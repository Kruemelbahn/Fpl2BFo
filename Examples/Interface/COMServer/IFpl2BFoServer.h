...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE GetCountOfFPLStationsOnTrack(LONGLONG* pnCountOfStationsOnTrack) const = 0;
	virtual HRESULT STDMETHODCALLTYPE GetFPLStationTrackArray(LONGLONG* pnResult) const = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE GetElementFromFPLStationOnTrack(LONGLONG iIndex, BSTR pzElementName, BSTR* pzElementValue) const = 0;
